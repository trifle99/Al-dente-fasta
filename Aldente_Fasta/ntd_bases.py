...
def base_graphs(file):
    ...
    #plt.plot(res['N%'], label='N%') #No point adding this because normal N% values are so small it won't show up effectively on a combined graph where ylim stretches upto 0-100
